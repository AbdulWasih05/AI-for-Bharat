                ...
                <nav className="landing-nav">
                    <div className="nav-container">
                        ...
                        <div className="nav-buttons">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=15551445754&text=Namaste%20Nirman%20Mitra" target="_blank" rel="noopener noreferrer" className="nav-btn-whatsapp">
                        ...
                        <div className="premium-whatsapp-portal">
                            ...
                            <div className="concentric-portal">
                                ...
                                <div className="phone-mockup">
                                    ...
                                    <a href="https://api.whatsapp.com/send?phone=15551445754&text=Namaste%20Nirman%20Mitra" target="_blank" rel="noopener noreferrer" className="premium-cta-pill" style={{ textDecoration: 'none' }}>
